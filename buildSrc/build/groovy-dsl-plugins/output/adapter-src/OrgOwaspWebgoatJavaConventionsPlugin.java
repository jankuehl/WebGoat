...
/**
 * Precompiled org.owasp.webgoat.java-conventions script plugin.
 **/
public class OrgOwaspWebgoatJavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_OrgOwaspWebgoatJavaConventions").asSubclass(BasicScript.class);
